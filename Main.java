                    ...
                    while (true) {
                        ...
                        switch (chon) {
                            case 1:
                                ...
                                //       list.addToTail(new ListNode(new Product(id, tenSP, gia, soLuong)), new Product(id, tenSP, gia, soLuong));
                                break;
                            ...
                            case 2:
                                ...
                                // list.add(new ListNode(new Product(id, tenSP, gia, soLuong)),0);
                                list.addToTail(new ListNode(new Product(id2, tenSP2, gia2, soLuong2)), new Product(id2, tenSP2, gia2, soLuong2));
    ...
    public static void readFileQueue(Queue queue, String fileName) throws IOException {
        ...
        try {
            ...
            while ((thisLine = br.readLine()) != null) {
                ...
                Product newProduct = new Product(Integer.parseInt(info[0]), String.valueOf(info[1]), Integer.parseInt(info[2]), Integer.parseInt(info[3]));
